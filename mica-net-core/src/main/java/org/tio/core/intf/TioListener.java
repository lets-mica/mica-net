...
public interface TioListener {
	 ...
	 * @throws Exception Exception
	 */
	default void onAfterDecoded(ChannelContext context, Packet packet, int packetSize) throws Exception {
	 ...
	 * @throws Exception Exception
	 */
	default void onAfterHandled(ChannelContext context, Packet packet, long cost) throws Exception {
	 ...
	 * @throws Exception Exception
	 */
	default void onBeforeClose(ChannelContext context, Throwable throwable, String remark, boolean isRemove) throws Exception {
