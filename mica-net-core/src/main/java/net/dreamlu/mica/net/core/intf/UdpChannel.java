...
/**
 * UDP 会话抽象，仅承载 UDP 业务真正需要的远端地址与回写能力，
 * 与 {@link net.dreamlu.mica.net.core.ChannelContext} 解耦，
 * 不引入 SSL、Runnable 队列、维护表等重量级状态。
 * <p>
 * 作为 {@link UdpHandler} 中 {@code handler(packet, channel)} 的上下文参数使用。
 *
 * @author L.cm
 */
