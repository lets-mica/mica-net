...
public class DigestUtils {
	...
	public static String sha1Hex(String data) {
		return encodeHex(sha1(data.getBytes(StandardCharsets.UTF_8)));
	}
	...
	public static byte[] sha224(String data) {
		return sha224(data.getBytes(StandardCharsets.UTF_8));
	}
	...
	public static String sha224Hex(String data) {
		return encodeHex(sha224(data.getBytes(StandardCharsets.UTF_8)));
	}
	...
	public static String sha256Hex(String data) {
		return encodeHex(sha256(data.getBytes(StandardCharsets.UTF_8)));
	}
	...
	public static String sha384Hex(String data) {
		return encodeHex(sha384(data.getBytes(StandardCharsets.UTF_8)));
	}
	...
	public static String sha512Hex(String data) {
		return encodeHex(sha512(data.getBytes(StandardCharsets.UTF_8)));
	}
	...
	public static byte[] hmacMd5(String data, String key) {
		return hmacMd5(data.getBytes(StandardCharsets.UTF_8), key);
	}
	...
	public static String hmacMd5Hex(String data, String key) {
		return encodeHex(hmacMd5(data.getBytes(StandardCharsets.UTF_8), key));
	}
	...
	public static byte[] hmacSha1(String data, String key) {
		return hmacSha1(data.getBytes(StandardCharsets.UTF_8), key);
	}
	...
	public static String hmacSha1Hex(String data, String key) {
		return encodeHex(hmacSha1(data.getBytes(StandardCharsets.UTF_8), key));
	}
	...
	public static byte[] hmacSha224(String data, String key) {
		return hmacSha224(data.getBytes(StandardCharsets.UTF_8), key);
	}
	...
	public static String hmacSha224Hex(String data, String key) {
		return encodeHex(hmacSha224(data.getBytes(StandardCharsets.UTF_8), key));
	}
	...
	public static String hmacSha256Hex(String data, String key) {
		return encodeHex(hmacSha256(data.getBytes(StandardCharsets.UTF_8), key));
	}
	...
	public static byte[] hmacSha384(String data, String key) {
		return hmacSha384(data.getBytes(StandardCharsets.UTF_8), key);
	}
	...
	public static String hmacSha384Hex(String data, String key) {
		return encodeHex(hmacSha384(data.getBytes(StandardCharsets.UTF_8), key));
	}
	...
	public static byte[] hmacSha512(String data, String key) {
		return hmacSha512(data.getBytes(StandardCharsets.UTF_8), key);
	}
	...
	public static String hmacSha512Hex(String data, String key) {
		return encodeHex(hmacSha512(data.getBytes(StandardCharsets.UTF_8), key));
	}
