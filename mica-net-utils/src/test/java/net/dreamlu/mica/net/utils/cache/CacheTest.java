package net.dreamlu.mica.net.utils.cache;
...
//		LRUCache<String, String> lruCache = new LRUCache<String, String>(3);
	...
	@Test
	public void timedCacheTest() throws IOException {
		try (TimedCache<String, String> timedCache = new TimedCache<>(4)) {
//		TimedCache<String, String> timedCache = new TimedCache<String, String>(DateUnit.SECOND.getMillis() * 3);
	 ...
	 */
	@Test
	public void whenContainsKeyTimeout_shouldCallOnRemove() throws IOException {
		int timeout = 50;
		try (TimedCache<Integer, String> ALARM_CACHE = new TimedCache<>(timeout)) {
