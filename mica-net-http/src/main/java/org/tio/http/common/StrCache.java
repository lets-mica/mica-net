...
public class StrCache {
	 ...
	 * value: byte[]对应的字符串
	 */
	private static final ConcurrentMap<Integer, String> BYTES_STRING_MAP = new ConcurrentHashMap<>(128);
	...
	public static String get(byte[] allbs, int start, int len) {
		...
		if (str == null) {
			...
			return CollUtil.computeIfAbsent(BYTES_STRING_MAP, hashcode, key -> new String(allbs, start, len));
		}
		return str;
	}
