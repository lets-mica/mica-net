...
public class Resps {
	...
	public static HttpResponse css(HttpRequest request, String bodyString, String charset) {
		return string(request, bodyString, charset, getMimeTypeStr(MimeType.TEXT_CSS_CSS, charset));
	}
	...
	public static HttpResponse resp404(HttpRequest request, RequestLine requestLine, HttpConfig httpConfig) throws Exception {
		...
		if (httpResource != null) {
			...
			return Resps.forward(request, file404 + "?tio_initpath=" + URLEncoder.encode(requestLine.getPathAndQuery(), httpConfig.getCharset()));
		}
	...
	public static HttpResponse resp500(HttpRequest request, RequestLine requestLine, HttpConfig httpConfig, Throwable throwable) throws Exception {
		...
		if (httpResource != null) {
			...
			return Resps.forward(request, file500 + "?tio_initpath=" + requestLine.getPathAndQuery());
		}
	...
	public static HttpResponse html(HttpRequest request, String bodyString, String charset) {
		return string(request, bodyString, charset, getMimeTypeStr(MimeType.TEXT_HTML_HTML, charset));
	}
	...
	public static HttpResponse js(HttpRequest request, String bodyString, String charset) {
		return string(request, bodyString, charset, getMimeTypeStr(MimeType.APPLICATION_JAVASCRIPT_JS, charset));
	}
	 ...
	 * @author tanyaowu
	 */
	public static HttpResponse string(HttpRequest request, String bodyString, String contentType) {
		return string(request, bodyString, request.httpConfig.getCharset(), contentType);
	}
	 ...
	 * @author tanyaowu
	 */
	public static HttpResponse string(HttpRequest request, String bodyString, String charset, String contentType) {
		HttpResponse ret = new HttpResponse(request);
		if (bodyString != null) {
			if (charset == null) {
	...
	public static HttpResponse try304(HttpRequest request, long lastModifiedOnServer) {
		...
		if (StrUtil.isNotBlank(ifModifiedSince)) {
			...
			try {
				...
				log.warn("{}, {}不是整数，浏览器信息:{}", request.getClientIp(), ifModifiedSince, request.getUserAgent());
				return null;
			}
		}
		return null;
	...
	public static HttpResponse txt(HttpRequest request, String bodyString, String charset) {
		return string(request, bodyString, charset, getMimeTypeStr(MimeType.TEXT_PLAIN_TXT, charset));
	}
